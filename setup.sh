...
IT_ADMIN_PASSWORD=changeme91
SECRETARY_TEST_USERNAME=sekreterare1
SECRETARY_TEST_PASSWORD=sekreterare1
SECRETARY_TEST_EMAIL=
...
EOF
    ...
    echo "Especially set: ADMIN_EMAIL/ADMIN_USERNAME + ADMIN_PASSWORD, ADMIN2_EMAIL/ADMIN2_USERNAME + ADMIN2_PASSWORD, IT_ADMIN_EMAIL/IT_ADMIN_USERNAME + IT_ADMIN_PASSWORD, SMTP_HOST, SMTP_PASS, MAIL_FROM"
else
